...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen pt-20 flex items-center justify-center p-4 bg-gray-50/80 font-sans relative overflow-hidden">
            ...
            <div className="absolute top-1/4 right-[-5%] w-96 h-96 bg-blue-500/20 rounded-full blur-3xl opacity-50" />
            <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 bg-red-500/10 rounded-full blur-3xl opacity-50" />
            ...
            >
                ...
                <div className="w-full md:w-1/2 p-8 lg:p-12 relative flex flex-col justify-center bg-white order-2 md:order-1">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-xs text-gray-400 mb-3 font-medium">Or sign up with</p>
                ...
                <div className="w-full md:w-1/2 p-12 bg-gradient-to-br from-blue-600 to-purple-600 text-white flex flex-col justify-center items-center text-center relative overflow-hidden order-1 md:order-2">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-blue-100/90 mb-8 text-sm leading-relaxed max-w-[250px] mx-auto">
                            Join HireGo AI and experience the future of hiring today.
                        </p>

                        <div className="space-y-3">
                            <p className="text-xs text-blue-200 uppercase tracking-widest font-semibold">ALREADY HAVE AN ACCOUNT?</p>
                            <button
