            ...
            >
                <div className="h-full flex flex-col">
                    ...
                    <div className="h-16 flex items-center justify-center border-b border-white/10">
                        ...
                        {!isSidebarOpen && <Briefcase className="text-neon-cyan" size={24} />}
                    </div>
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 glass border-b border-white/10 flex items-center justify-between px-4 sticky top-0 z-30">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-neon-cyan to-neon-purple flex items-center justify-center font-bold">
                            TC
                        </div>
                    </div>
                </header>
