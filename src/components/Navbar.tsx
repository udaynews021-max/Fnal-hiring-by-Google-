            ...
            <div className="container mx-auto max-w-7xl px-4 py-4">
                <div className="flex items-center justify-between">
                    ...
                    >
                        ...
                        <span className="text-2xl font-bold text-gradient">JobPortal</span>
                    </motion.div>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <motion.button
                            ...
                            className="px-6 py-2 rounded-xl bg-gradient-to-r from-neon-cyan to-neon-purple font-semibold shadow-neon-cyan hover:shadow-neon-purple transition-all text-white"
                        >
                            Sign In
                        </motion.button>
                    </div>
                ...
                {isOpen && (
                    ...
                    >
                        ...
                        <button
                            onClick={onSignInClick}
                            className="w-full px-6 py-2 rounded-xl bg-gradient-to-r from-neon-cyan to-neon-purple font-semibold shadow-neon-cyan text-white"
                        >
                            Sign In
                        </button>
                    </motion.div>
